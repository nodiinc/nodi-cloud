...
export default async function CompanyPage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative flex min-h-[60vh] flex-col items-center justify-center overflow-hidden px-6 pt-16 text-center">
        {/* Background effects */}
      ...
      <section className="py-24 px-6 border-t border-[var(--color-border)] relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl text-center relative">
          <p className="mb-6 text-sm font-medium uppercase tracking-widest text-[var(--color-accent)]">
            Our Vision
          </p>
      ...
      <footer className="border-t border-[var(--color-border)] py-12 px-6">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 md:flex-row">
          <div className="flex items-center gap-3">
            <Image src="/nodi-logo-symbol.png" alt="nodi" width={24} height={24} />
